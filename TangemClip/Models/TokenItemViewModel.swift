...
//  Tangem
//
//  Created by Alexander Osokin on 27.02.2021.
...
struct TokenItemViewModel: Identifiable, Equatable, Comparable {
    ...
    var tokenItem: TokenItem {
        ...
        return .blockchain(.init(blockchain))
    }
    ...
    static let `default` = TokenItemViewModel(state: .created, hasTransactionInProgress: false, name: "", fiatBalance: "", balance: "", rate: "", amountType: .coin, blockchain: .bitcoin(testnet: false), derivationPath: Blockchain.bitcoin(testnet: false).derivationPath, fiatValue: 0)
